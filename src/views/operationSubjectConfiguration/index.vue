    ...
    <div class="mediaHome">
        ...
        <el-config-provider :locale="zhCn">
            <el-table :data="tableDataList" class="table"
                ...
                <el-table-column label="公司全称" prop="remoteAdvertiserName"></el-table-column>
                <el-table-column label="公司简称" prop="company.companyName"></el-table-column>
                <el-table-column label="公司标识" prop="company.companyName"></el-table-column>
                <el-table-column label="可用状态" width="180px">
                    <template #default="scope">
                        <div v-if="scope.row.authStatus === 1">正在使用</div>
