<template>
  <div class="userModify">
    <el-container>
      ...
      <el-main>
        <el-form ref="userFormRef" :model="userForm" :rules="userFormRules" label-width="150px" label-position="right">
          <el-form-item label="快应用名称" prop="userName">
            <div v-if="route.query.type === 'modify' && accountStore.modifyUserInfo.userName">{{ userForm.userName }}
            </div>
            <el-input v-else v-model="userForm.userName" placeholder="请输入5-20位英文+数字组合的快应用名称"
          ...
          <el-form-item label="关联的投放媒体标识" prop="deptId2">
            <el-select multiple collapse-tags collapse-tags-tooltip v-model="userForm.deptId2" placeholder="请选择"
              style="width: 300px">
              <el-option v-for="d in OptionalDeptList" :key="d.id" :label="d.name" :value="d.id"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="投放时间设定" prop="params1">
            <div class="">
              ...
              <div class="">
                <!-- <div class=""></div> -->
                <el-date-picker v-model="userForm.params2" type="datetimerange" range-separator="To"
          ...
          <el-form-item label="是否启用的总开关" prop="roleIdList">
