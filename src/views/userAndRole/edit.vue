        ...
        <el-main>
          <el-form ref="userFormRef" :model="userForm" :rules="userFormRules" label-width="100px" label-position="left">
            ...
            <el-form-item label="姓名" prop="nickName">
              <el-input v-model="userForm.nickName" placeholder="请输入姓名" style="width: 300px"></el-input>
            </el-form-item>
            <el-form-item label="邮箱号码" prop="email">
              <el-input v-model="userForm.email" placeholder="请输入邮箱" style="width: 300px"></el-input>
            </el-form-item>
