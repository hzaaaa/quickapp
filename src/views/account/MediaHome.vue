<template>
  <div class="mediaHome">
    <el-row class="filter">
      ...
      <el-select class="filter-input" v-model="searchForm.companyId" placeholder="全部" clearable style="width: 300px">
...
const appType = computed(() => {
  ...
  if (route.path.includes("kuaishou")) return 3;
  return -1;
});
...
getCompanyListApi().then((res) => {
  console.log("getCompanyListApi", res.data.list);
