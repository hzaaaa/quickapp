    ...
    <el-container>
      ...
      <el-main>
        <el-row class="filter">
          ...
          <el-select v-model="searchForm.mediaCategory" placeholder="请选择" class="filter-input">
          ...
          <el-select v-model="searchForm.companyId" placeholder="请选择" class="filter-input">
            <el-option
          ...
          <el-col :span="14">
            <el-config-provider :locale="zhCn">
              ...
              >
                ...
                <el-table-column label="账户ID" prop="advertiserId" width="160"></el-table-column>
...
getCompanyListApi().then((res) => {
  ...
  optionalCompanyList.value = res.data;
});
